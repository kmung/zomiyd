...
function Footer() {
    return (
        <footer className='bg-blue-primary text-white py-4 px-4 flex flex-col md:flex-row justify-center items-center text-center space-y-2 md:space-y-0 md:space-x-2'>
            <p>©2024 
