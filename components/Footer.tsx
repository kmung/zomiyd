        ...
        <footer className="bg-blue-secondary text-white pt-8">
            <div className="max-w-6xl w-[calc(100%-2rem)] mx-auto px-6 py-6 grid grid-cols-1 md:grid-cols-3 gap-8 bg-blue-primary rounded-lg shadow-lg">
                ...
                <div className="flex flex-col items-center md:items-start space-y-4">
                    <Link href={"/"}>
                        <Image src={logoNoBg} alt="Zomi YD Logo" width={80} height={80} className="rounded-md bg-white" />
                    </Link>
                ...
                <div className="flex flex-col items-center md:items-start space-y-4">
                    ...
                    <div className="flex space-x-4">
                        <a href="https://www.facebook.com/zomiyd" target="_blank" rel="noopener noreferrer" className="hover:text-pink-secondary">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
                            <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
                        </svg>
                        </a>
                        <a href="https://www.youtube.com/@zomiyd" target="_blank" rel="noreferrer" className="hover:text-pink-secondary">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
                        ...
                        <a href="https://www.instagram.com/zomiyd/" target="_blank" rel="noreferrer" className="hover:text-pink-secondary">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
